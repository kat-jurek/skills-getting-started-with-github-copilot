...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practice and friendly matches to build basketball skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Develop soccer techniques and participate in scrimmages",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "noah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act, perform, and explore theater techniques with fellow students",
